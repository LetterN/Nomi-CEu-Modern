...
StartupEvents.registry('item', event => {
    ...
    event.create('crystal_matrix_plate').tag('forge:plates/crystal_matrix').tag('forge:plates')
    ...
    event.create('infinity_plate').tag('forge:plates/infinity').tag('forge:plates').displayName('\u00A7cInfinity Plate')

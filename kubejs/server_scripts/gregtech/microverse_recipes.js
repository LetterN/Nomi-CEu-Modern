...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.advanced_microverse('t_five_second')
        ...
        .itemOutputs('64x gtceu:uraninite_ore', '64x gtceu:palladium_ore', '64x gtceu:realgar_ore', '64x gtceu:bastnasite_ore', '64x gtceu:sphalerite_ore', '64x gtceu:monazite_ore', '64x gtceu:endstoneerpearl_block', '16x gtceu:osmiridiumyes_ore', '64x gtceu:boron_dust', '64x gtceu:molybdenum_ore', '64x gtceu:beryllium_ore', '64x gtceu:beryllium_ore')
        .duration(1000)
        .EUt(7500)
...
ServerEvents.recipes(event => {
    event.recipes.gtceu.advanced_microverse_ii('t_seven_first')
        .itemInputs('kubejs:microminer_t7', '64x kubejs:dilitihium_crystal', '64x kubejs:dilithium_crystal', 'kubejs:gem_sensor', '64x kubejs:wither_realm_data', '64x kubejs:wither_realm_data', '64x kubejs:wither_realm_data', '64x kubejs:wither_realm_data')
    ...
    event.recipes.gtceu.advanced_microverse_ii('t_seven_second')
        ...
        .itemOutputs('32x draconicevolution:dragon_heart', '64x minecraft:dragon_egg', '64x minecraft:dragon_egg', '64x minecraft:dragons_breath', '64x kubejs:endstoneer_dragon_scale', '64x kubejs:endstoneer_dragon_scale', '64x kubejs:endstoneer_dragon_scale', '64x minecraft:gold_block', '64x minecraft:gold_block', '64x minecraft:gold_block', '64x gtceu:silver_block', '64x gtceu:silver_block', '64x minecraft:diamond_block', '64x minecraft:diamond_block', '64x gtceu:platinum_block', '16x gtceu:ruthenium_block')
        .duration(1500)
        .EUt(31250)

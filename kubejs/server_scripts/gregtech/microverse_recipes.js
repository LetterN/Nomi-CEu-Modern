...
ServerEvents.recipes(event => {
        ...
        event.recipes.gtceu.basic_microverse('t_one_third')
            ...
            .itemOutputs('64x gtceu:cassiterite_ore', '64x minecraft:redstone_ore', '64x gtceu:nickel_ore', '64x gtceu:ilmenite_ore', '64x gtceu:ilmenite_ore', '64x gtceu:ilmenite_ore', '64x gtceu:uraninite_ore', '64x gtceu:galena_ore', '64x gtceu:galena_ore', '64x gtceu:molybdenum_ore', '64x ad_astra:moon_stone', '64x minecraft:paper', '64x gtceu:salt_ore')
            .inputFluids(Fluid.of('gtceu:rocket_fuel', 8000))
            .duration(500)
            .EUt(500)
        ...
        event.recipes.gtceu.basic_microverse('t_three_one')
...
ServerEvents.recipes(event => {
    event.recipes.gtceu.advanced_microverse('t_four_first')
...
event.recipes.gtceu.advanced_microverse('t_five_second')
...
event.recipes.gtceu.advanced_microverse('t_six_first')
...
event.recipes.gtceu.advanced_microverse('t_six_second')
...
event.recipes.gtceu.advanced_microverse('t_six_third')
...
ServerEvents.recipes(event => {
    event.recipes.gtceu.advanced_microverse_ii('t_seven_first')
        .itemInputs('kubejs:microminer_t7', '64x minecraft:paper', '64x minecraft:paper', 'kubejs:gem_sensor', '64x kubejs:wither_realm_data', '64x kubejs:wither_realm_data', '64x kubejs:wither_realm_data', '64x kubejs:wither_realm_data')
        .itemOutputs('kubejs:lair_of_the_chaos_guardian_data')
        .duration(1500)
        .EUt(31250)

    event.recipes.gtceu.advanced_microverse_ii('t_seven_second')
        .itemInputs('kubejs:microminer_t7', '32x kubejs:quantum_flux', '64x minecraft:paper', '64x minecraft:paper', '32x kubejs:dragon_lair_data')
        .itemOutputs('32x minecraft:paper', '64x minecraft:dragon_egg', '64x minecraft:dragon_egg', '64x minecraft:dragon_breath', '64x minecraft:book', '64x minecraft:book', '64x minecraft:book', '64x minecraft:gold_block', '64x minecraft:gold_block', '64x minecraft:gold_block', '64x gtceu:silver_block', '64x gtceu:silver_block', '64x minecraft:diamond_block', '64x minecraft:diamond_block', '64x gtceu:platinum_block', '16x gtceu:ruthenium_block')
        .duration(1500)
        .EUt(31250)

    event.recipes.gtceu.advanced_microverse_ii('t_eight_first')
        .itemInputs('kubejs:microminer_t8', '64x kubejs:quantum_flux', '64x minecraft:paper', '64x minecraft:paper', '64x minecraft:paper', '64x minecraft:paper', 'kubejs:lair_of_the_chaos_guardian_data')
    ...
    event.recipes.gtceu.advanced_microverse_ii('t_eight_second')
        .itemInputs('kubejs:microminer_t8', '64x kubejs:quantum_flux', '64x minecraft:paper', '64x minecraft:paper', '64x minecraft:paper', '64x minecraft:paper', '64x kubejs:wither_realm_data', '64x kubejs:wither_realm_data', )
        .itemOutputs('32x gtceu:quantum_star', '64x gtceu:quantum_eye', '16x avaritia:neutronium_ingot', 'gtceu:gravi_star')
        .duration(2000)
        .EUt(62500)

    event.recipes.gtceu.advanced_microverse_ii('t_nine_first')
    ...
    event.recipes.gtceu.advanced_microverse_ii('t_nine_second')
        .itemInputs('kubejs:microminer_t9', '4x gtceu:neutron_reflector', '4x gtceu:awakened_draconium_block', 'kubejs:stellar_creation_data')
        .itemOutputs('64x avaritia:neutronium_nugget', '64x avaritia:neutronium_nugget', '64x avaritia:neutronium_nugget', '64x avaritia:neutronium_nugget', '64x avaritia:neutronium_nugget', '64x gtceu:neutronium_nugget', '64x avaritia:neutronium_nugget', '64x avaritia:neutronium_nugget', '64x avaritia:neutronium_nugget', '64x avaritia:neutronium_nugget')
        .duration(3000)
        .EUt(250000)

    event.recipes.gtceu.advanced_microverse_ii('t_ten_first')
